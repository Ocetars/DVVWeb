...
<template>
  <div class="ground-controls">
    ...
    <label>
      地面宽度：
      <input type="number" v-model.number="localGroundWidth" @change="updateWidth" step="0.1" />
    </label>
    <label>
      地面深度：
      <input type="number" v-model.number="localGroundDepth" @change="updateDepth" step="0.1" />
    </label>
